...
namespace CBAM.NATS
{
   ...
   public sealed class NATSConnectionCreationInfo : NetworkConnectionCreationInfo<NATSConnectionCreationInfoData, NATSConnectionConfiguration, NATSInitializationConfiguration, NATSProtocolConfiguration, NATSAuthenticationConfiguration, NATSPoolingConfiguration>
   {
   ...
   public sealed class NATSConnectionCreationInfoData : NetworkConnectionCreationInfoData<NATSConnectionConfiguration, NATSInitializationConfiguration, NATSProtocolConfiguration, NATSAuthenticationConfiguration, NATSPoolingConfiguration>
   {
   }
   ...
   public sealed class NATSInitializationConfiguration : NetworkInitializationConfiguration<NATSProtocolConfiguration, NATSAuthenticationConfiguration, NATSPoolingConfiguration>
   {
   }
         ...
         if ( !( creationInfo.CreationData?.Initialization?.ConnectionPool?.ConnectionsOwnStringPool ?? default ) )
         {
            ...
            (this._networkStreamConfig, this._remoteAddress, this._stringPool) = creationInfo.CreateStatefulNetworkStreamFactoryConfiguration().Create(
               ...
               async ( state ) =>
               {
                  ...
                  (var end, var preReadLength) = await state.Item4.ReadUntilMaybeAsync( buffer, 0, 0, ClientProtocolConsts.CRLF, ClientProtocolConsts.READ_COUNT );
                  ...
                  ClientProtocol.SetPreReadLength( rState, end, preReadLength );

                  return sslMode != ConnectionSSLMode.NotRequired && creationInfo.ProvideSSLStream != null;
               },
