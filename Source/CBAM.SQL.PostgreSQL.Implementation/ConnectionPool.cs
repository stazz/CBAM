...
{
   internal sealed class PgSQLConnectionAcquireInfo : ConnectionAcquireInfoImpl<PgSQLConnection, PostgreSQLProtocol, StatementBuilder, SQLStatementExecutionResult, System.IO.Stream>
   {
